...
DECLARE
    v_user_id uuid;
    v_email text := 'bryanjeffsart@gmail.com'; -- Replace with Bryan's actual email
...
BEGIN
    ...
    -- Prepare the application data (the exact JSON from the form)
    v_application_data := '{
        ...
        "1346d368-b560-44c8-b026-14776c1b9a79": "Oh the poor civilians. I'\''m grieved that we suffer a cultural wound at the loss of Gaza. I'\''m not sure exac",
        "18fdf65b-a5c9-414d-bbfa-3057a7e2fba7": "No not logical but it'\''s not excluding the possibility either. ",
        "241d9c89-0323-4003-9a20-7c19309ba488": "When I was 17 I was enfj but very close to estj so I'\''m not sure how it stacks up however I can go deep on my astrology for a thorough being assessment",
        ...
        "4b108d7c-d05e-4036-b060-cd18323a0f6f": "Yes, I definitely won'\''t bring an animal with me even though it is super cute.",
        ...
        "702ae994-6f64-4e81-a2b3-2593fbc0c937": "Passport or drivers licence usually. Haha. But ah I'\''m guessing you mean in terms of gender identity. So I'\''m a man.",
        ...
        "8039351b-c928-46bc-9389-3ca354033580": "I don'\''t know them if there are any. ",
        ...
        "d2565ce6-c5b8-4969-b17d-b1232f270f18": "I'\''m chuckling to myself because it'\''s not beliefs that have changed but how to integrate them. For instance I believe when I am confronted or offended by something or someone there will be a misalignment of values or a misunderstanding. In that case I can make an enquiry and register/consider my values. How I respond determines whether I am integrated and able to act with agency and respect. If I defer and compromise I forfeit harmony and my value.",
        "e0e50caf-fdc0-4476-a424-c250ada6d962": "I'\''m refining and expanding my artistic placemaking practice and seeking collaboration with people of substance and depth. I'\''m engaged with spiritual and material values as they converse and I'\''m on a mission to find friends and opportunities to develop. ",
        "ea59d026-9f24-4b22-b06e-8a3221d9b95c": "It'\''s all in what we do and say and how we move. The body tells the truth. How we cook and clean and dance. Many people open at different rates on different terms. So getting to know someone is generally on their terms :P",
...
SELECT 
    ...
    a.status,
    a.created_at,
    jsonb_pretty(a.data) as application_data
FROM applications a
JOIN auth.users u ON a.user_id = u.id
WHERE u.email = 'bryanjeffs@example.com'  -- Replace with Bryan's actual email
