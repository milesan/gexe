        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full p-2 border rounded-sm focus:ring-2 focus:ring-red-500 focus:border-red-500"
            />
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              ...
              className="bg-red-500 text-white px-4 py-2 rounded-sm hover:bg-red-600 disabled:bg-gray-300 disabled:cursor-not-allowed"
            >
              {saving ? 'Saving...' : 'Save'}
            </button>
          </div>
