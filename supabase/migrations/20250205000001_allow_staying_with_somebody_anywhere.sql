-- Allow "Staying with somebody" bookings to be assigned to any accommodation item
-- This enables guests to stay with their friends/family in any accommodation type

BEGIN;

-- Update the assign_accommodation_item_to_booking function to allow cross-accommodation assignments
-- for "Staying with somebody" bookings
